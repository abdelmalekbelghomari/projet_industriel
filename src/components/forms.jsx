        ...
        <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-customBlue rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p class="text-sm text-gray-300 mt-4 leading-relaxed"> {description} </p>
                    ...
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center">
                            ...
                            <a href="mailto:contact@eatybox.com" class="text-white text-sm ml-4">
                                {email}
                            </a>
                        </li>
                        <li class="flex items-center">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="https://youtu.be/dQw4w9WgXcQ" class="text-white text-sm ml-4">
                                {address}
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="flex mt-12 space-x-4">
                        <li class="bg-customRed hover:bg-customRedDark h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    <p class="text-sm font-semibold text-gray-800">J'ai un problème avec les...</p>
