        ...
        <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div class="md:max-w-md w-full px-4 py-4">
            <form onSubmit={handleSubmit}>
              <div class="mb-12">
                <h3 class="text-customRed text-3xl">Connexion</h3>
              ...
              <div class="mt-12">
                <button type="submit" class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-customBlue hover:bg-customRed focus:outline-none">
                  Se connecter
                </button>
              </div>

              <div class="space-x-6 flex justify-center mt-6">
                <button type="button" onClick={handleGoogleSignIn} class="border-none outline-none" className='google-button'>
                ...
                <button type="button" onClick={handleAppleSignIn}
                  class="border-none outline-none" className='apple-button'>
                ...
                <button type="button" onClick={handleFacebookSignIn}
                  class="border-none outline-none" className='facebook-button'>
